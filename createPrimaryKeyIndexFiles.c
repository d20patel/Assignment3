...
int main(int argc, char *argv[])
{
    ...
    data_filename = malloc(strlen(filenameSkeleteon) + 5);
    strcpy(data_filename, filenameSkeleteon);
    strcat(data_filename, ".data");

    sparse_index_filename = malloc(strlen(filenameSkeleteon) + 5);
    strcpy(sparse_index_filename, filenameSkeleteon);
    strcat(sparse_index_filename, ".sparse_index");

    dense_index_filename = malloc(strlen(filenameSkeleteon) + 5);
